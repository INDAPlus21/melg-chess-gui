use eliasfl_chess::{Color as Colour, Game, GameState, Piece as PieceType};
/**
 * Chess GUI template.
...
struct AppState {
    ...
    board: Game, // Save piece positions, which tiles has been clicked, current colour, etc...
}
...
impl event::EventHandler<ggez::GameError> for AppState {
    ...
    fn mouse_button_up_event(&mut self, ctx: &mut Context, button: MouseButton, x: f32, y: f32) {
        if button == MouseButton::Left { /* check click position and update board accordingly */ }
    }
}
